...
SECRET_KEY = 'django-insecure-plw5t2i+)t%+j%xvi77)q(#5^jgo4f3yi7_t3((5+ka72zsgqm'
...
# include the static directory in your project
STATICFILES_DIRS = [BASE_DIR / 'static']

# For production (on Render or other environments):
